...
try
{
  ...
  rs = database.query(" select t_gn.*, t_mk.mc mkmc" +
                      " from t_js_gn, t_gn, t_mk" +
                      " where t_js_gn.gnid = t_gn.gnid" + 
...
{
  (new Log()).log("error", "admin/xitong/jsgn_select.jsp：" + Global.getInstance().getTime() + "：" + e.getMessage());
}
finally
{
  database.close();
...
<html>
<head>
<title>角色功能_已选列表</title>
<link href="../../style/style.css" rel="stylesheet" type="text/css">
<script language="javascript">
function work_delete(obj)
{
  if (window.confirm("确定删除数据"))
    document.jsgn_select_frame.location.href = "jsgn_do.jsp?operate=delete&jsid=<%=jsid%>&gnid=" + obj;
}

function work_go(obj) 
{
  document.jsgn_select_form.action = "jsgn_select.jsp";
  document.jsgn_select_form.target = "_self";
  document.jsgn_select_form.cpage.value = obj;
  document.jsgn_select_form.submit();
...
<body>
<form name="jsgn_select_form" method="post">
...
<iframe name="jsgn_select_frame" src="" frameborder="0" scrolling="no" width="0" height="0"></iframe>
