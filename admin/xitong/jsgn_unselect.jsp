...
{
  (new Log()).log("error", "admin/xitong/jsgn_unselect.jsp：" + Global.getInstance().getTime() + "：" + e.getMessage());
}
finally
{
  database.close();
...
<html>
<head>
<title>角色功能_未选列表</title>
<link href="../../style/style.css" rel="stylesheet" type="text/css">
<script language="javascript">
function work_add(obj)
{
  document.jsgn_unselect_frame.location.href = "jsgn_do.jsp?operate=add&jsid=<%=jsid%>&gnid=" + obj;
}

function work_go(obj) 
{
  document.jsgn_unselect_form.action = "jsgn_unselect.jsp";
  document.jsgn_unselect_form.target = "_self";
  document.jsgn_unselect_form.cpage.value = obj;
  document.jsgn_unselect_form.submit();
...
<body>
<form name="jsgn_unselect_form" method="post">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr><td width="100%" valign="top">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
        	<td height="30" align="center" class="th box_left box_top" nowrap>功能</td>
        	<td align="center" class="th box_left box_top" nowrap>模块</td>
        	<td align="center" class="th box_left box_top box_right" nowrap>操作</td>
        </tr>
    <%for (i = 0; i < v.size(); i++)
      {%>
        <tr>
          <td height="30" align="center" class="td box_top box_left" nowrap><%=(((Properties) v.get(i)).getProperty("gnmc"))%></td>
...
<input type="hidden" name="wxgnmc" value="<%=wxgnmc%>">
<input type="hidden" name="jsid" value="<%=jsid%>">
</form>

<iframe name="jsgn_unselect_frame" src="" frameborder="0" scrolling="no" width="0" height="0"></iframe>
